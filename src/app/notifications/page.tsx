...
export const metadata: Metadata = {
  title: "お知らせ一覧ページ",
  description: "Retasusan's Blogのお知らせ一覧ページ",
};
    ...
    <div className="bg-base text-gray-800 min-h-screen">
      ...
      <section className="px-20 py-10 text-gray-500 text-center">
        <div className="w-[60%] min-w-[525px] mx-auto">
          <h2 className="text-3xl font-bold cursor-default">お知らせ一覧</h2>
        </div>
      </section>

      {/* 記事リスト */}
      <section className="w-[90%] mx-auto px-28 m-10 grid grid-cols-auto-fit-350 gap-10 max-w-[1200px]">
        {/* カード間のマージンを設定 */}
        {contents?.map((notification, i) => (
          <div
            key={i}
          ...
          >
            ...
            {/* 投稿日時 */}
            <div className="flex items-center ml-2 mt-2 mb-[-6px]">
              {/* 公開日 */}
              <div className="flex-shrink-0">
                <Image src={clock} width={15} height={15} alt="clock icon" />
              </div>
              ...
              <span className="ml-1 text-gray-600 mt-[1px] text-sm">
                {formattedTime(notification.updatedAt)}
              </span>
            </div>
